    ...
    <!-- Intro -->
      <section id="intro" class="main style2 fullscreen">
        <div class="content">
          ...
          <p>I'm Habib, a trainee web developer. I enrolled in a coding course in April 2017 (<a href="http://becode.org" target="_blank">Becode</a>) and I <strong>loved</strong> it so much that I decided to change my career path and dedicated 100% of my time and energy to my new passion...And now i would like to give <strong></strong> some of that good energy!</p>
          <footer>
    ...
    <!-- Two -->
      ...
      <section id="three" class="main style2 left dark fullscreen">
        <div class="content box style2">
          ...
          <p><a href="https://twitter.com/pixeline?lang=es">One of our coaches</a> at Becode mentioned __ when we were discussing the potentials internships. He praised your agency and I became curious. So I googled you and waouww! The stuff you have done...</p>
